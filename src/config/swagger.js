...
const options = {
  definition: {
    ...
    tags: [
      ...
      { name: "Admin - Diet Plans", description: "Approve or reject doctor diet plans" },
      ...
      { name: "Patient - Diet Plan", description: "Patient approved diet plan" },
      ...
      { name: "Doctor - Diet Plans", description: "Create and submit diet plans" },
